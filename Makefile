...
M_OBJ = $(M_SRC:.c=.o)
B_SRC = $(addprefix ./bonus/, get_fonts_bonus.c mlx_display_moves_bonus.c free_all_bonus.c get_images_bonus.c gnl_utils_bonus.c gnl_bonus.c key_hooks_bonus.c list_utils_bonus.c \
